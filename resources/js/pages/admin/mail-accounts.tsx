...
import { MailAccount, mailAccountFormSchema, User, userFormSchema } from '@/lib/schema';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <AdminLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Mail Accounts" description="Manage mail mailAccounts" cta={<AddUserDialog />} />
                                        ...
                                        <TableCell>
                                            <div className="flex gap-2">
                                                ...
                                                <Dialog open={isDeleteOpen && selectedAccount?.id === account.id} onOpenChange={setIsDeleteOpen}>
                                                    <DialogTrigger asChild>
                                                        <Button variant="destructive" size="sm" onClick={() => setSelectedAccount(account)}>
                                                            Delete
                                                        </Button>
                                                    </DialogTrigger>
                                                    <DialogContent>
                        ...
                        {mailAccounts.last_page > 1 && (
                            <div className="flex gap-1">
                                <Button
                                    ...
                                    onClick={() => router.get(`/admin/users?page=${mailAccounts.current_page - 1}`)}
                                >
                                    <ChevronLeftIcon />
                                </Button>
